...
class ColecaoService {
    ...
    public function listarColecao(int $limit, int $offset): array {
        return $this->repository->listarItensColecao($limit, $offset);
    }

    public function getTotalItens(): int {
        return $this->repository->contarTotalColecao();
    }
}