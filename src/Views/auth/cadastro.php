...
<head>
    ...
    <title>SoundHaven - Cadastro</title>
...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <form action="index.php?url=processar_cadastro" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="senha" name="senha" class="form-control" placeholder="Escolha uma senha forte" required autocomplete="new-password">
                    </div>
                </div>
            ...
            <div class="auth-footer">
                Já tem uma conta? <a href="index.php?url=login">Entrar</a>
            </div>
        </div>
    </div>
</body>
